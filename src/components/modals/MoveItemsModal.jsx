...
export default function MoveItemsModal({ count = 0, onClose }) {
  return (
    <BaseModal onClose={onClose}>
      <div className="w-[420px] flex flex-col rounded-2xl bg-white p-6 shadow-[0px_4px_50px_rgba(33,33,33,0.08),0px_4px_6px_rgba(33,33,33,0.04)]">
        {/* Title */}
        <h2 className="text-[18px] font-bold mb-2">Select a project</h2>
        <p className="text-[14px] text-[#6D6D6D] mb-4">
          Please enter a project where <span className="font-bold">{count} items</span> will be included.
        </p>
